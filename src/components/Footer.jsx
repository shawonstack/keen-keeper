          ...
          <div className="mb-8">
            ...
            <div className="flex justify-center gap-3">
              <a href="#" className="w-9 h-9 rounded-full overflow-hidden hover:opacity-80 transition-opacity">
                <img src={`${BASE}icons/instagram.png`} alt="Instagram" className="w-full h-full object-cover" />
              </a>
              <a href="#" className="w-9 h-9 rounded-full overflow-hidden hover:opacity-80 transition-opacity">
                <img src={`${BASE}icons/facebook.png`} alt="Facebook" className="w-full h-full object-cover" />
              </a>
              <a href="#" className="w-9 h-9 rounded-full overflow-hidden hover:opacity-80 transition-opacity">
                <img src={`${BASE}icons/twitter.png`} alt="Twitter/X" className="w-full h-full object-cover" />
              </a>
            </div>
          </div>
