        ...
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 text-center shadow-sm">
              ...
              <h2 className="font-semibold text-gray-900 text-lg">{friend.name}</h2>

              {/* Status */}
              <span className={`inline-block text-xs px-3 py-1 rounded-full font-medium mt-2 ${status.className}`}>
                {status.label}
              </span>
              ...
              <div className="flex flex-wrap justify-center gap-1.5 mt-3">
                {friend.tags.map(tag => (
                  <span key={tag} className="text-xs px-2.5 py-0.5 bg-brand-pale text-brand-dark rounded-full capitalize font-medium">
                    {tag}
                  </span>
                ))}
              </div>
              ...
              {/* Bio */}
              <p className="text-gray-500 text-xs mt-4 leading-relaxed italic">"{friend.bio}"</p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-white border border-gray-100 rounded-2xl p-5 text-center shadow-sm">
                ...
                <div className="text-xs text-gray-400 mt-1 font-medium">Days Since Contact</div>
              </div>
              <div className="bg-white border border-gray-100 rounded-2xl p-5 text-center shadow-sm">
                <div className="text-3xl font-bold text-gray-900">{friend.goal}</div>
                <div className="text-xs text-gray-400 mt-1 font-medium">Goal (Days)</div>
              </div>
              <div className="bg-white border border-gray-100 rounded-2xl p-5 text-center shadow-sm">
                <div className="text-xl font-bold text-gray-900">{formatDate(friend.next_due_date)}</div>
                <div className="text-xs text-gray-400 mt-1 font-medium">Next Due</div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              ...
              <div className="grid grid-cols-3 gap-3">
                <button
                  ...
                  className="flex flex-col items-center gap-2 py-4 rounded-xl border border-gray-100 hover:bg-brand-pale hover:border-brand-light transition-all cursor-pointer bg-white"
                >
                  <img src={`${BASE}icons/call.png`} alt="Call" className="w-7 h-7 object-contain" style={{ mixBlendMode: 'multiply' }} />
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-2 py-4 rounded-xl border border-gray-100 hover:bg-brand-pale hover:border-brand-light transition-all cursor-pointer bg-white"
                >
                  <img src={`${BASE}icons/text.png`} alt="Text" className="w-7 h-7 object-contain" style={{ mixBlendMode: 'multiply' }} />
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-2 py-4 rounded-xl border border-gray-100 hover:bg-brand-pale hover:border-brand-light transition-all cursor-pointer bg-white"
                >
                  <img src={`${BASE}icons/video.png`} alt="Video" className="w-7 h-7 object-contain" style={{ mixBlendMode: 'multiply' }} />
