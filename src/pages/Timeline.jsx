...
const typeConfig = {
  call: {
    label: 'Call',
    icon: <img src={`${BASE}icons/call.png`} alt="Call" className="w-4 h-4 object-contain" style={{ mixBlendMode: 'multiply' }} />,
    color: 'bg-white',
    badge: 'bg-green-100 text-green-700',
  },
  text: {
    label: 'Text',
    icon: <img src={`${BASE}icons/text.png`} alt="Text" className="w-4 h-4 object-contain" style={{ mixBlendMode: 'multiply' }} />,
    color: 'bg-white',
    badge: 'bg-blue-100 text-blue-700',
  },
  video: {
    label: 'Video',
    icon: <img src={`${BASE}icons/video.png`} alt="Video" className="w-4 h-4 object-contain" style={{ mixBlendMode: 'multiply' }} />,
    color: 'bg-white',
