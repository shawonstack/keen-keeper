...
export default function Home() {
  ...
  const summaryCards = [
    { label: 'Total Friends', value: totalFriends, icon: <Users size={18} />, color: 'text-brand-dark' },
    { label: 'On Track', value: onTrack, icon: <CheckCircle size={18} />, color: 'text-green-600' },
    { label: 'Need Attention', value: needAttention, icon: <AlertCircle size={18} />, color: 'text-amber-600' },
    { label: 'Interactions This Month', value: interactions, icon: <Zap size={18} />, color: 'text-purple-600' },
  ]
  ...
  return (
    <div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <h2 className="text-lg font-semibold text-gray-800 mb-5">Your Friends</h2>
